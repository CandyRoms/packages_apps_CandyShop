...
import org.candy.support.colorpicker.ColorPickerPreference;
...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorPickerPref.setDefaultValue(CandyUtils.getThemeAccentColor(getContext()));
        ...
        if (colorMode == COLOR_TYPE_ACCENT) {
            mColorPickerPref.setNewPreviewColor(CandyUtils.getThemeAccentColor(getContext()));
        }
